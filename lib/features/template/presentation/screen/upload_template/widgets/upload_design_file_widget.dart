...
class UploadDesignFileWidget extends StatefulWidget {
  final bool isDark;
  final Function(File?) onFileSelected;
  final Function(String?) onUrlChanged;

  const UploadDesignFileWidget({
    super.key,
  ...
  @override
  State<UploadDesignFileWidget> createState() => _UploadDesignFileWidgetState();
}

class _UploadDesignFileWidgetState extends State<UploadDesignFileWidget> {
  ...
  Future<void> _pickDesignFile() async {
    try {
      final file = await _filePickerService.pickDesignFile();
      if (file != null) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          _buildLabel('Upload Design File', isRequired: true),
          ...
          _selectedTab == 'upload'
              ? (_selectedFile == null
                  ? _buildUploadArea(
                      ...
                      subtitle: 'PSD, AI, XD, FIG formats',
  ...
  Widget _buildUrlInput() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Enter design file URL',
        hintStyle: TextStyle(
          fontSize: 14.sp,
